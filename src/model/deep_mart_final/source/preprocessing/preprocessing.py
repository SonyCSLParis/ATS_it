...
if _name_ == "_main_":
    ...
    # path = os.path.abspath(_file_ + '/../../../data/_collections/proc_w_s_2_columns_shuffle_with_meta_data.csv')
    # newpath = os.path.abspath(
    #     _file_ + '/../../../data/_collections/proc_w_s_2_columns_shuffle_with_meta_data_without_low_similarity.csv')
    # df = pd.read_csv(path)
    # print(df.shape)
    #
