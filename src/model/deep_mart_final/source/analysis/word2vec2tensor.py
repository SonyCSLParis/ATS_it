...
How to use
----------
#. Convert your word-vector with this script (for example, we'll use model_deep from
   `gensim-data <https://rare-technologies.com/new-download-api-for-pretrained-nlp-models-and-datasets-in-gensim/>`_) ::
    python -m gensim.downloader -d glove-wiki-gigaword-50  # download model_deep in word2vec format
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="Set this flag if word2vec model_deep in binary format (default: %(default)s)",
    )
