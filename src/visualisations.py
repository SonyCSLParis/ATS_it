...
def create_visualisation(final_corpus):
    ...
    key1, value1 = PoS_analysis(INTERMEDIATE_DIR + '/no_stop_sentences_1.txt')
    #key11, value11 = PoS_analysis(INTERMEDIATE_DIR + '/ADV_no_stop_sentences_1.txt')
    key2, value2 = PoS_analysis(INTERMEDIATE_DIR + '/no_stop_sentences_2.txt')
    ...
    print(f'The amount of SVO in Original sentences is {amount_SVO(final_corpus, 2)}')
