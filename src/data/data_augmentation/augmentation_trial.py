...
to_parse = CSV_FILES_PATH + '/ter_tea_sim/tts.csv'
to_generate =  CSV_FILES_PATH + '/ter_tea_sim/tts_augmented_back_and_forth.csv'
back_and_forth(file_to_parse = to_parse, file_to_generate = to_generate)
